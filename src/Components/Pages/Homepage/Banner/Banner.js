...
// The following class component is for the top-most section of the landing page, which says "Changing the way students learn, reskill, network...", as well as the images on the right, ending with the "Request a demo" button.
